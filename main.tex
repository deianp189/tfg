...
\begin{figure}[ht]
	\centering
	% \includegraphics[width=0.8\textwidth]{arquitectura_snort_agent.png}
	\caption{Representación gráfica de la arquitectura interna del agente R-Snort mostrando Snort 3, FastAPI y subsistemas de monitorización.}
