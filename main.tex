...
\begin{figure}[hbtp]
	...
	\end{subfigure}
	\caption{Sistema Grafana-Labs.} % Solo si quieres un caption global
...
\thispagestyle{empty}
\newpage
\markboth{}{}              % limpia encabezados/pies anteriores
% ----------------------------------------------------------------
%                     COMIENZO DE LOS ANEXOS
% ----------------------------------------------------------------

% ------------------- PRIMER ANEXO -------------------------------
\anexo{Descripción de la plataforma R-Snort}
...
\thispagestyle{empty}
\newpage
\anexo{Repositorios y guía rápida}
...
Para clonar y ejecutar la instalación automática del agente en una Raspberry Pi o servidor Ubuntu/Debian se deben seguir los pasos del Código \ref{lst:descarga-repo}.

\begin{lstlisting}[language=bash, caption={Descarga del repositorio de snort-agent.}, label={lst:descarga-repo}]
	git clone https://github.com/deianp189/snort-agent.git
	cd snort-agent
	sudo ./install.sh
\end{lstlisting}

En la Figura \ref{fig:docu-uno} se muestra la documentación inicial del repositorio del agente snort.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{apendix_agent/1.png}
	\caption{Documentación y guía de inicio rápido disponible en el repositorio del agente.}
	\label{fig:docu-uno}
\end{figure}
...
\thispagestyle{empty}
\newpage
\anexo{Guía para escribir reglas Snort 3}
...
(Ver Código \ref{lst:snort3-regla})
